...
def add_train_args(parser):
    ...
    files.add_argument('--train-file', type=str,
                       default='Persian_SQuAD_train-v2.0-processed-regexp.txt',
                       help='Preprocessed train file')
    files.add_argument('--dev-file', type=str,
                       default='Persian_SQuAD_dev-v2.0-processed-regexp.txt',
                       help='Preprocessed dev file')
    files.add_argument('--dev-json', type=str, default='Persian_SQuAD_dev-v2.0.json',
                       help=('Unprocessed dev file to run validation '
                             'while training on'))
    files.add_argument('--embed-dir', type=str, default=EMBED_DIR,
                       help='Directory of pre-trained embedding files')
    files.add_argument('--embedding-file', type=str,
                       default='glove-vectors-farsi-dedup.txt',
